<template>
  <div class="row justify-between height_section3 fondo_naranja text-white">
    <div class="absolute q-pa-lg column items-start text-h4 text-bold" style="z-index:20">
      <div>Nuestra</div>
    ...
    <div class="col-12 column items-center justify-center full-height q-pt-xl mobile_img_section3">
      <div class="text-subtitle1 column justify-between">
        ...
        <div class="q-pb-lg">Metodologías <br> activas y <b>trabajo <br> colaborativo</b></div>
        ...
        <div class="q-pb-lg">Construimos <br><b>ciudadanía</b>, para <br><b>impactar</b><br> positivamente <br> nuestro entorno.</div>
      </div>
    </div>
