<template>
     ...
     <div class="row relative-position bg-primary">
      <div class="col-12 col-md-6 text-appearance">
        <h3 class="text-weight-bold">
          En Campito aplicamos nuestro programa <span class="text-white bg-warning">Fortalezas</span> del Carácter
        </h3>
   ...
   <div class="height_section2 row">
    <div class="col-12 q-pa-md column items-start text-h4 text-bold">
      <div>Incentivamos el juego,<br/> la pasión</div>
      <div class="border_green q-px-sm">y el propósito</div>
    </div>
